...
public final class Constants {
    ...
    public static final String GENRE_SQL_GENERATOR = "genreSQLGenerator";
    public static final String USER_SQL_GENERATOR = "userSQLGenerator";
    public static final String MOVIE_SQL_GENERATOR = "movieSQLGenerator";
    public static final String REVIEW_SQL_GENERATOR = "reviewSQLGenerator";
