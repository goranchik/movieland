...
public class JdbcReviewDao implements ReviewDao {
    ...
    public List<Review> findAll() {
        ...
        List<Review> reviews = jdbcTemplate.query(findAllReviewsSQL, new ReviewRowMapper(movieDao, userDao));
    ...
    public List<Review> findByMovieId(int id) {
        ...
        long startTime = System.currentTimeMillis();
        List<Review> reviews = jdbcTemplate.query(findReviewsByMovieIdSQL, new Object[]{id}, new ReviewRowMapper(movieDao, userDao));
